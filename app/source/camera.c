...
static void draw_controls(u16* screen, bool review, bool failed, int active_camera) {
    dmaFillHalfWords(RGB15(31, 30, 25) | BIT(15), screen, CAMERA_WIDTH * CAMERA_HEIGHT * 2);
    print_text(review ? "LOOKING GOOD?" : "SAY HELLO!", 12, 10, screen, RGB15(4, 5, 8), 2);
    print_string_embedded("01 SCAN > 02 PHOTO > 03 DRAW", 12, 32, screen);
    draw_rounded_box(screen, 8, 49, 240, 57, 9, RGB15(31, 31, 30), RGB15(4, 5, 8));
    ...
    draw_rounded_box(screen, 8, 114, 240, 29, 8, RGB15(31, 26, 3), RGB15(4, 5, 8));
    print_text(review ? "A  KEEP PHOTO" : "A  TAKE PHOTO", 50, 122, screen, RGB15(4, 5, 8), 2);
    draw_rounded_box(screen, 8, 152, 240, 24, 7, RGB15(31, 31, 30), RGB15(4, 5, 8));
